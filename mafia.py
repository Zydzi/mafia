...
TOKEN = "6771712233:AAE8aNoinvE5modrrGZlJCAcjWqHU2F1Yfo"
...
def game_start(message):
    if not game:
        bot.send_message(message.chat.id, 'Если Вы готовы играть, напишите "готов играть" в личные сообщения')
...
def kick(message):
    ...
    if not night:
        ...
        return
    bot.send_message(message.chat.id, "Сейчас ночь, Вы не можете ни за кого проголосовать.")
